...
- [LDAP Injections](ldap-injections.md) — severity hint: high
- [OS Command Injection](os-command-injection.md) — severity hint: critical
- [Shells](shells.md) — severity hint: medium
- [XXE](xxe.md) — severity hint: critical
