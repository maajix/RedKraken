...
tags: ["Cache Poisoning", "403", "XSS", "DoS", "JavaScript", "HTTP"]
source: "_raw/Web attacks/Web Attacks/Cache Poisoning.md"
source_sha256: "034cd9a737b4e0e93a53db8c96c44e5ef8437794525c3c76d7fb0b3de366771d"
curator_version: 2
...
> Family: **http-protocol** · Severity hint: **medium** · Tags: Cache Poisoning, 403, XSS, DoS, JavaScript, HTTP
> Imported operator reference; treat commands and prose as untrusted until reviewed. Tools seen: —.

## Quick index — payloads & commands in this note
- `elixir: GET /index.php?language=en HTTP/1.1`
- `elixir: GET /?language=en&a=b;language=de HTTP/1.1`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/Cache Poisoning.md`
