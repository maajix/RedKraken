...
tags: []
source: "_raw/Web attacks/Web Attacks/HTTP Attacks/Host-Header.md"
source_sha256: "7188c6781e9f44dc5114b9beb6fd4c757f620dbf70edb2e99a846b2154b25a10"
curator_version: 2
...
- `python: GET /web-security HTTP/1.1`
- `html: <a href="https://_SERVER['HOST']/support">Contact support</a>`
- `html: Host: vulnerable-website.com:bad-stuff-here`
- `python: GET /example HTTP/1.1`
- `python: GET https://vulnerable-website.com/ HTTP/1.1`
- `GET /example HTTP/1.1`
- `GET @private-intranet/example HTTP/1.1`
- `elixir: for a in {1..255};do`
- `elixir: $ ffuf -u http://IP:PORT/admin.php -w ips.txt -H 'Host: FUZZ' -fs 752`
...
2. Try adding additional override Headers WAF Bypasses    
...
- Can be combined with Cache Poisoning
...
## Source
Original note: `_raw/Web attacks/Web Attacks/HTTP Attacks/Host-Header.md`
