...
Afterward, a second request can be specified. This scenario typically involves [HTTP request smuggling](notion://www.notion.so/pentesting-web/http-request-smuggling), a technique where extra headers or body elements appended by the server post-injection can lead to various security exploits → [Request Smuggling & HTTP Desync](Request%20Smuggling%20&%20HTTP%20Desync%20d2b55b032f3f45fd9d4afdbdfd3b0087.md) 
