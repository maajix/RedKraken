...
![Untitled](Request%20Smuggling%20&%20HTTP%20Desync/Untitled.png)
...
- **HTTP1 Must Die**
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image.png)
    ...
    **Hidden-Visible (H-V)**
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%201.png)
    ...
    *Frontend sees the Content-Length header, backend does not. Thus the frontend parses the payload and gives it to the backend. The backend does not see that content as payload, but as a full new HTTP request since there is no delimiter in HTTP.*
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%202.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%203.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%204.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%205.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%206.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%207.png)
    
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%208.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%209.png)
...
- **TCP Stream of HTTP requests**
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2010.png)
...
- **Desynchronization**
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2011.png)
...
![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2012.png)
...
- Details
    ...
    **Note:** The sequences `[\x09]` and `[\x0b]` are not the literal character sequences used in the obfuscation. Rather they denote the horizontal tab character (ASCII `0x09`) and vertical tab character (ASCII `0x0b`).
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2013.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2014.png)
...
- Details
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2015.png)
    
    Create tab group:
    
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2016.png)
    
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2017.png)
    ...
    **Identification:**
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2018.png)
    
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2019.png)
...
- Details
    ...
    **Tab Group**
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2020.png)
    
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2021.png)
...
- 
    ...
    **Bypassing Security Checks**
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2022.png)
    ...
    **Exploit**
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2023.png)
...
- Details
    ...
    **Request Smuggler Burp**
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2024.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2025.png)
    
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2026.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2027.png)
    ...
    ![image.png](Request%20Smuggling%20&%20HTTP%20Desync/image%2028.png)
