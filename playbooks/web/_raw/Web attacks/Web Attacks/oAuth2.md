...
Status: Erledigt
Tags: Authentication (../Tags/Authentication%2027f2c37daa29806cb382fb4d3ccf9448.md), XSS (../Tags/XSS%2027f2c37daa29805dadb2ff82553491b9.md), Request Smuggling (../Tags/Request%20Smuggling%2027f2c37daa2980c5b573d71cfe8224a6.md), CSRF (../Tags/CSRF%2027f2c37daa2980a0aa8cf404707e4b45.md), Open Redirect (../Tags/Open%20Redirect%2027f2c37daa29809f8952deb2c81c7faf.md), Account Takeover (ATO) (../Tags/Account%20Takeover%20(ATO)%2027f2c37daa2980f4abc6c479151370af.md)
Tags 2: Auth
...
- **Implicit grant type**
    ...
    ![Untitled](oAuth2/Untitled%201.png)
...
![image.png](oAuth2/image.png)

![image.png](oAuth2/image%201.png)
...
- **Mutable Claims Attack**
    ...
    ![image.png](oAuth2/image%202.png)
...
- **Redirect Scheme Hijacking mobile applications (interesting since less hunted)**
    ...
    ![image.png](oAuth2/image%203.png)
...
- **Flawed scope validation**
    ...
    ![image.png](oAuth2/image%204.png)
...
- **Unverified user registration / Client Confusion Attack**
    ...
    [Attack via Google oAuth2 Playground ](oAuth2/Attack%20via%20Google%20oAuth2%20Playground%201a62c37daa2980bdb807e4429867c895.md)
    ...
    ![image.png](oAuth2/image%205.png)
    
    ![image.png](oAuth2/image%206.png)
    

![Untitled](oAuth2/Untitled%202.png)
