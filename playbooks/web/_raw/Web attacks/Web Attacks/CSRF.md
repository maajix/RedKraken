...
Status: Erledigt
Tags: CSRF (../Tags/CSRF%2027f2c37daa2980a0aa8cf404707e4b45.md), HTTP (../Tags/HTTP%2027f2c37daa29807d92cfe57074fa61d0.md), Account Takeover (ATO) (../Tags/Account%20Takeover%20(ATO)%2027f2c37daa2980f4abc6c479151370af.md)
Tags 2: HTML, HTTP
...
![Untitled](CSRF/Untitled.png)

![Untitled](CSRF/Untitled%201.png)
...
4. Attempt to inject a Carriage Return Line Feed (CRLF) to alter the CSRF cookie's value
    1. Or use any other bug like [XSS](XSS%2098f56b0916394dc7b529ed7c68af95db.md) 
...
If a **CSRF token** is being used as **defense** you could try to **ex-filtrate it** abusing a [XSS](XSS%2098f56b0916394dc7b529ed7c68af95db.md) vulnerability or a [Dangling Markup ](Dangling%20Markup%20d51af4ee29614630a89ac971b6349427.md) vulnerability
