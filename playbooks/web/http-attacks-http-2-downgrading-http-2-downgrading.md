...
tags: []
source: "_raw/Web attacks/Web Attacks/HTTP Attacks/HTTP 2 Downgrading/HTTP 2 Downgrading.md"
source_sha256: "1dd7efdc6288c2ff7afaaa436c7b0b2beaf36d6dc0d383b719f16ca1920298ef"
curator_version: 2
...
- `A request or response that includes a payload body can include a content-length header fie`
- `:method POST`
- `POST / HTTP/1.1`
- `python: :method POST`
- `POST / HTTP/1.1`
- `python: POST /index.php HTTP/2`
- `python: POST /index.php HTTP/2`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/HTTP Attacks/HTTP 2 Downgrading/HTTP 2 Downgrading.md`
