---
technique: "1_Introduction_to_HTTP_verb_Tampering_INFO"
family: "http-protocol"
severity_hint: "low"
tags: []
source: "_raw/Web attacks/Web Attacks/HTTP Attacks/Verb Tampering/1_Introduction_to_HTTP_verb_Tampering_INFO.md"
source_sha256: "617e01935f5800316d849402c9dd922e354b86ce3677fce91a2eaeac83d0e1ea"
curator_version: 2
...
- `xml: <Limit GET POST>    Require valid-user</Limit>`
- `php: $pattern = "/^[A-Za-z\s]+$/";if(preg_match($pattern, $_GET["code"])) {`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/HTTP Attacks/Verb Tampering/1_Introduction_to_HTTP_verb_Tampering_INFO.md`
