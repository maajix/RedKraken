---
technique: "DNS Rebinding: SSRF Filter Bypass"
family: "ssrf-xxe-file"
severity_hint: "high"
tags: []
source: "_raw/Web attacks/Web Attacks/DNS Rebinding/DNS Rebinding SSRF Filter Bypass.md"
source_sha256: "66930eaadcce1c9efdbe2a94c7bb1b18d32dc30840d1e4feaddfe1ea059dafd8"
curator_version: 2
...
- `python: @app.route('/', methods=['POST'])`
- `python: # Host addresses`
- `python: # Host addresses`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/DNS Rebinding/DNS Rebinding SSRF Filter Bypass.md`
