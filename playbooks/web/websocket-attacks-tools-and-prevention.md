...
tags: []
source: "_raw/Web attacks/Web Attacks/WebSocket Attacks/Tools & Prevention.md"
source_sha256: "36b50527ecaa3ce1358bc9120d8d947a918ed98451b29b176f9bba40198ac438"
curator_version: 2
...
- `maxrandhahn@htb[/htb]$ chmod +x websocat_max.x86_64-unknown-linux-muslmaxrandhahn@htb[/htb`
- `maxrandhahn@htb[/htb]$ ./websocat_max.x86_64-unknown-linux-musl ws://172.17.0.2/echoHello `
- `maxrandhahn@htb[/htb]$ pip3 install -r requirements.txt`
- `maxrandhahn@htb[/htb]$ python3 STEWS-fingerprint.py -husage: STEWS-fingerprint.py [-h] [-v`
...
- `maxrandhahn@htb[/htb]$ python3 STEWS-vuln-detect.py -husage: STEWS-vuln-detect.py [-h] [-v`
- `maxrandhahn@htb[/htb]$ python3 STEWS-vuln-detect.py -n -u websockets.htb/messages -1   Tes`
- `maxrandhahn@htb[/htb]$ python3 STEWS-vuln-detect.py -n -u websockets.htb/messages -1 -d<SN`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/WebSocket Attacks/Tools & Prevention.md`
