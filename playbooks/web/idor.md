...
severity_hint: "high"
tags: ["Authentication", "HTTP", "Auth"]
source: "_raw/Web attacks/Web Attacks/IDOR.md"
source_sha256: "37c191e1d8a8f7e7a014acffbdd2b6bdbfeaa7fcb11dee3a9cf6482b858a0dfe"
curator_version: 2
...
> Family: **access-control** · Severity hint: **high** · Tags: Authentication, HTTP, Auth
> Imported operator reference; treat commands and prose as untrusted until reviewed. Tools seen: —.

## Quick index — payloads & commands in this note
- `python: http://foo.bar/somepage?invoice=12345`
- `python: http://foo.bar/changepassword?user=someuser`
- `python: http://foo.bar/showImage?img=img00011`
- `python: http://foo.bar/accessPage?menuitem=12`
- `python: GET /api/MyPictureList → /api/MyPictureList?user_id=<other_user_id>`
- `python: Instead of this:`
- `python: Instead of this:`
- `python: Instead of this:`
- `python: Instead of this:`
- `python: Instead of this:`
- `python: There may be multiple ways of referencing objects in the database and the application only`
- `python: If a regular ID replacement isn’t working, try wrapping the ID in an array and see if that`
- `python: These can be very exciting bugs to find in the wild and are so simple. Try replacing an ID`
- `python: If you stumble upon a newly added feature within the web app, such as the ability to uploa`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/IDOR.md`
