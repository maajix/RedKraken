---
technique: "Tools of the Trade (Python Deserialization)"
family: "deserialization"
severity_hint: "critical"
tags: []
source: "_raw/Web attacks/Web Attacks/Deserialization Attacks/Tools of the Trade (Python Deserialization).md"
source_sha256: "68190f60a4b8dc2f8eddda4678f889767c19e0e65e2f9e774d1874afaac1924d"
curator_version: 2
...
- `python: import yaml`
- `bash: python3 yaml-example.py Traceback (most recent call last):`
- `bash: git clone https://github.com/j0lt-github/python-deserialization-attack-payload-generator.g`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/Deserialization Attacks/Tools of the Trade (Python Deserialization).md`
