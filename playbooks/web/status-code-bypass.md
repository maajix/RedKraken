---
technique: "Status Code Bypass"
family: "http-protocol"
severity_hint: "low"
tags: ["403", "HTTP"]
source: "_raw/Web attacks/Web Attacks/Status Code Bypass.md"
source_sha256: "dccf900ce88225756c794be8c41528efa264f4b05e249e7a1c871ff7c59b1f3e"
curator_version: 2
...
> Family: **http-protocol** · Severity hint: **low** · Tags: 403, HTTP
> Imported operator reference; treat commands and prose as untrusted until reviewed. Tools seen: —.

## Quick index — payloads & commands in this note
- `haskell: site.com/secret => 403`
- `haskell: site.com/secret.txt => 403`
- `haskell: https://site.com/secret => 403`
- `haskell: /`
...
- HTTP Headers Fuzzing
    ...
    - If the page is **behind a proxy**, try abusing Request Smuggling & HTTP Desync **or** [**hop-by-hop headers](https://book.hacktricks.xyz/pentesting-web/abusing-hop-by-hop-headers).**
...
- Other Bypasses
    ...
    - Try to **stress the server (**Race Conditions & Timing Attacks**)** by sending common GET requests ([It worked for this guy with Facebook](https://medium.com/@amineaboud/story-of-a-weird-vulnerability-i-found-on-facebook-fc0875eb5125))
...
## Source
Original note: `_raw/Web attacks/Web Attacks/Status Code Bypass.md`
