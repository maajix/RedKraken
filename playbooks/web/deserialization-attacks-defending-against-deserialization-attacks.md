---
technique: "Defending against Deserialization Attacks"
family: "deserialization"
severity_hint: "critical"
tags: []
source: "_raw/Web attacks/Web Attacks/Deserialization Attacks/Defending against Deserialization Attacks.md"
source_sha256: "0c0ca82a6a2c2941bdff8f7f99dee4b8f02619b980fcfaa48866cf6cc623bd28"
curator_version: 2
...
- `python: ...`
- `python: ...`
- `bash: maxrandhahn@htb[/htb]$ tree exploitexploit`
- `python: # HTBooks GmbH & Co. KG`
- `python: import pickle`
- `bash: maxrandhahn@htb[/htb]$ python3 exploit.py gASVPAAAAAAAAACMBXBvc2l...SNIP...5IC1lIC9iaW4vc2`
- `bash: maxrandhahn@htb[/htb]$ nc -nvlp 9999Ncat: Version 7.93 ( https://nmap.org/ncat )`
- `php: ...`
- `php: ...`
- `php: ...`
- `php: ...`
- `bash: maxrandhahn@htb[/htb]$ echo eyJuYW1lIjoicGVudGVzdCIsImVtYWlsIjoicGVudGVzdEB0ZXN0LmNvbSIsIn`
- `bash: maxrandhahn@htb[/htb]$ tail /tmp/htbank.log [13.10.2022 12:35:15] Serialized user 'pentest`
...
## Source
Original note: `_raw/Web attacks/Web Attacks/Deserialization Attacks/Defending against Deserialization Attacks.md`
