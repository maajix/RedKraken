...
- [DNS Rebinding](dns-rebinding.md) — severity hint: high
- [Open Redirection](open-redirection.md) — severity hint: medium
- [PDF Generators](pdf-generators.md) — severity hint: medium
- [SSRF](ssrf.md) — severity hint: high
