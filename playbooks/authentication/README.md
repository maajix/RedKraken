...
- [AWS Cognito](cloud-aws-cognito.md) — severity hint: medium
- [Password Reset](http-attacks-password-reset.md) — severity hint: medium
- [Sign Up (Login / Register)](sign-up-login-register.md) — severity hint: medium
- [Type Juggling](type-juggling.md) — severity hint: high
