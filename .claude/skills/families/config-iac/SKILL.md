...
Load the matching modern card: `deployment-configuration-exposure.md`,
`api-inventory-resource-consumption.md`, or `security-logging-alerting.md`.
Use `information-disclosure-debug-artifacts.md` for source maps, backups, stack
