...
4. Continue bounded recon rounds while there is a meaningful **surface delta**. Stop when the configured **round budget** is exhausted or after **two no-progress rounds**. Maintain the **coverage ledger** for skipped and exhausted methods.
